# Phase 2 part one — the record

What was built to make the collection chain work end to end, with the hardware
runs, the measurements and the decisions worth not re-making. Moved here out of
`docs/project-conventions.md`, unchanged, because that file is read at the start
of every session and this is read when it is needed.

The phase now under way is Phase 3 — see `docs/phase3-pilot-scope.md`.
